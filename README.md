...
## Contents
 ...
 - [Chapters](#chapters)
   ...
   * [1. Spring Basics](#spring-basics)
   * [2. Spring Boot](#spring-boot)
   * [3. JPA and Flyway](#jpa-and-flyway)
   * [4. JSON REST APIs](#json-rest-apis)
   * [5. Custom Format Support](#custom-format-support)
   * [6. Testing](#testing)
   * [7. Security](#security)
   * [8. REST Template](#rest-template)
